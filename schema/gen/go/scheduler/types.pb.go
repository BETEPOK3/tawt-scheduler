...
func (x *CreateTask) GetInput() string {
	if x != nil {
		return x.Input
	}
	return ""
...
var file_scheduler_types_proto_rawDesc = []byte{
	...
	0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x42, 0x78, 0x0a, 0x2e, 0x72, 0x75,
...
var file_scheduler_types_proto_depIdxs = []int32{
	...
	4, // 3: scheduler.TaskType.gama:type_name -> scheduler.TaskTypeGama
